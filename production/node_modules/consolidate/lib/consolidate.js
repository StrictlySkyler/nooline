...
exports.swig.render = function(str, options, fn){
  var engine = requires.swig || (requires.swig = null);
  try {
...
exports.atpl.render = function(str, options, fn){
  var engine = requires.atpl || (requires.atpl = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
    fn(null, tmpl(options));
  } catch (err) {
...
exports.liquor.render = function(str, options, fn){
  var engine = requires.liquor || (requires.liquor = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
    fn(null, tmpl(options));
  } catch (err) {
...
exports.ejs.render = function(str, options, fn){
  var engine = requires.ejs || (requires.ejs = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
    fn(null, tmpl(options));
  } catch (err) {
...
exports.eco.render = function(str, options, fn){
  var engine = requires.eco || (requires.eco = null);
  try {
...
exports.jazz.render = function(str, options, fn){
  var engine = requires.jazz || (requires.jazz = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
...
exports.jqtpl.render = function(str, options, fn){
  var engine = requires.jqtpl || (requires.jqtpl = null);
  try {
...
exports.haml.render = function(str, options, fn){
  var engine = requires.hamljs || (requires.hamljs = null);
  try {
...
exports.whiskers = function(path, options, fn){
  var engine = requires.whiskers || (requires.whiskers = null);
...
exports['haml-coffee'].render = function(str, options, fn){
  var engine = requires.HAMLCoffee || (requires.HAMLCoffee = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
    fn(null, tmpl(options));
  } catch (err) {
...
exports.hogan.render = function(str, options, fn){
  var engine = requires.hogan || (requires.hogan = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str, options));
...
exports.templayed.render = function(str, options, fn){
  var engine = requires.templayed || (requires.templayed = null);
  try {
...
exports.handlebars.render = function(str, options, fn) {
  var engine = requires.handlebars || (requires.handlebars = null);
  try {
...
exports.underscore.render = function(str, options, fn) {
  var engine = requires.underscore || (requires.underscore = null);
  try {
...
exports.qejs = function (path, options, fn) {
  try {
    var engine = requires.qejs || (requires.qejs = null);
...
exports.walrus.render = function (str, options, fn) {
  var engine = requires.walrus || (requires.walrus = null);
  try {
...
exports.mustache.render = function(str, options, fn) {
  var engine = requires.mustache || (requires.mustache = null);
  try {
...
exports.mote.render = function(str, options, fn){
  var engine = requires.mote || (requires.mote = null);
  try {
...
exports.toffee = function(path, options, fn){
  var toffee = requires.toffee || (requires.toffee = null);
...
exports.toffee.render = function(str, options, fn) {
  var engine = requires.toffee || (requires.toffee = null);
  try {
...
exports.dot.render = function (str, options, fn) {
  var engine = requires.dot || (requires.dot = null);
  try {
    var tmpl = cache(options) || cache(options, engine.compile(str));
    fn(null, tmpl(options));
  } catch (err) {
